...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Set the default sort order to "likes"
    let sortOrder = "title";
    ...
    sortOptions.forEach(option => {
        option.addEventListener('click', (event) => {
            sortOrder = event.target.getAttribute('data-sort'); // Update sortOrder based on user selection
            displayGallery(); // Refresh the gallery with the new sorting order
        });
    });
